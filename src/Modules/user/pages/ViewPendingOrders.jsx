    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-4 border-gray-200 border-t-yellow-600 mx-auto mb-4"></div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-12 sm:p-16 text-center">
              <div className="max-w-sm mx-auto">
                ...
                <p className="text-gray-600">
                  You don't have any orders waiting for payment at the moment.
                </p>
              </div>
            </div>
          ) : (
              ...
              <div className="mb-6">
                ...
                <div className="space-y-4">
                  {selectedOrder.items.map((item, index) => (
                    <div
                      key={index}
                      className="flex gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200 hover:border-yellow-300 transition-colors"
                    >
                      <div className="flex-shrink-0">
                        <img
